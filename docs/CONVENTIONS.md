...
Confirmado em preto. Previsto em cinza médio ou hachurado. **A hachura quer dizer
previsto, e só aparece em bloco:** no quadradinho da legenda, no segmento previsto
da barra da home, no segmento programado da barra de próximos meses e nas cápsulas
de parcelamento. Linha de lançamento nunca é hachurada, e previsto de valor certo
é igual a previsto estimado na tela. Ver [ADR 0024](DECISIONS.md). Sobra positiva em verde dessaturado,
negativa em vinho.
...
2. **Controle sem tela avisa, mas continua sem tela.** As setas de mês, o botão
   de novo lançamento e o "ver mais" mostram um aviso dizendo que a tela não
   existe, em vez de não fazerem nada. É curativo, não conserto: as três telas
   continuam nas pendências abaixo.
